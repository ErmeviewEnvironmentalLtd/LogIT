...
class Ui_QueryWidget(object):
    def setupUi(self, QueryWidget):
        ...
        self.complexScriptText = QtGui.QPlainTextEdit(self.complexQueryTab)
        font = QtGui.QFont()
        ...
        self.complexScriptText.setObjectName(_fromUtf8("complexScriptText"))
        self.horizontalLayout.addWidget(self.complexScriptText)
    ...
    def retranslateUi(self, QueryWidget):
        ...
        self.queryTabWidget.setTabText(self.queryTabWidget.indexOf(self.complexQueryTab), _translate("QueryWidget", "Complex Query", None))
