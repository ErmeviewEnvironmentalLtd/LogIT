...
class RunSummaryTest(unittest.TestCase):
    ...
    def test_loadLogContents(self):
        ...
        self.assertEqual(len(log_store.ddv), 901, 'Complete ddv length fail')
        self.assertEqual(len(log_store.mb), 901, 'Complete mb length fail')
        self.assertEqual(len(log_store.flow_out), 901, 'Complete flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 901, 'Complete flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 901, 'Complete time_steps length fail')
        ...
        self.assertEqual(len(log_store.ddv), 330, 'Interrupted ddv length fail')
        self.assertEqual(len(log_store.mb), 330, 'Interrupted mb length fail')
        self.assertEqual(len(log_store.flow_out), 330, 'Interrupted flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 330, 'Interrupted flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 330, 'Interrupted time_steps length fail')
        ...
        self.assertEqual(len(log_store.ddv), 330, 'Unstable ddv length fail')
        self.assertEqual(len(log_store.mb), 330, 'Unstable mb length fail')
        self.assertEqual(len(log_store.flow_out), 330, 'Unstable flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 330, 'Unstable flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 330, 'Unstable time_steps length fail')
        ...
        self.assertEqual(len(log_store.ddv), 330, 'Partial ddv length fail')
        self.assertEqual(len(log_store.mb), 330, 'Partial mb length fail')
        self.assertEqual(len(log_store.flow_out), 330, 'Partial flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 330, 'Partial flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 330, 'Partial time_steps length fail')
        ...
        self.assertEqual(len(log_store.ddv), 901, 'Complete after partial ddv length fail')
        self.assertEqual(len(log_store.mb), 901, 'Complete after partial mb length fail')
        self.assertEqual(len(log_store.flow_out), 901, 'Complete after partial flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 901, 'Complete after partial flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 901, 'Complete after partial time_steps length fail')
