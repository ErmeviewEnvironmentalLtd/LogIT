...
class RunSummaryTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_dir = r'C:\Users\duncan.runnacles\Documents\Programming\Python\LogIT\Regression_Test_Data\Run_Summary'
    ...
    def test_getHoursFromDateStr(self):
        ...
        test_time1 = '3:15:00'
        test_time2 = '13:45:00'
        hms1 = self.summary.getHoursFromDateStr(test_time1)
        hms2 = self.summary.getHoursFromDateStr(test_time2)
#         hours1, minutes1, seconds1 = self.summary.getHoursFromDateStr(test_time1)
#         hours2, minutes2, seconds2 = self.summary.getHoursFromDateStr(test_time2)
        self.assertTupleEqual(hms1, (3.25, 15.0, 0.0), 'hours1 equality test fail: ' + str(hms1))
        self.assertTupleEqual(hms2, (13.75, 45.0, 0.0), 'hours2 equality test fail: ' + str(hms1))
    ...
    def test_loadLogContents(self):
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_complete.tlf', 'Complete tlf_path fail')
        self.assertEqual(len(log_store.ddv), 93, 'Complete ddv length fail: ' + str(len(log_store.ddv)))
        self.assertEqual(len(log_store.mb), 93, 'Complete mb length fail')
        self.assertEqual(len(log_store.flow_out), 93, 'Complete flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 93, 'Complete flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 93, 'Complete time_steps length fail')
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_interrupted.tlf', 'Interrupted tlf_path fail')
        self.assertEqual(len(log_store.ddv), 35, 'Interrupted ddv length fail')
        self.assertEqual(len(log_store.mb), 35, 'Interrupted mb length fail')
        self.assertEqual(len(log_store.flow_out), 35, 'Interrupted flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 35, 'Interrupted flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 35, 'Interrupted time_steps length fail')
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_unstable.tlf', 'Unstable tlf_path fail')
        self.assertEqual(len(log_store.ddv), 35, 'Unstable ddv length fail')
        self.assertEqual(len(log_store.mb), 35, 'Unstable mb length fail')
        self.assertEqual(len(log_store.flow_out), 35, 'Unstable flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 35, 'Unstable flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 35, 'Unstable time_steps length fail')
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_partial.tlf', 'Partial tlf_path fail')
        self.assertEqual(len(log_store.ddv), 35, 'Partial ddv length fail')
        self.assertEqual(len(log_store.mb), 35, 'Partial mb length fail')
        self.assertEqual(len(log_store.flow_out), 35, 'Partial flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 35, 'Partial flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 35, 'Partial time_steps length fail')
        ...
        entry.tlf_path = 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_complete.tlf'
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_complete.tlf', 'Complete after partial tlf_path fail')
        self.assertEqual(len(log_store.ddv), 93, 'Complete after partial ddv length fail')
        self.assertEqual(len(log_store.mb), 93, 'Complete after partial mb length fail')
        self.assertEqual(len(log_store.flow_out), 93, 'Complete after partial flow_in length fail')
        self.assertEqual(len(log_store.flow_in), 93, 'Complete after partial flow_out length fail')
        self.assertEqual(len(log_store.time_steps), 93, 'Complete after partial time_steps length fail')
        ...
        self.assertEqual(entry.tlf_path, 'C:\\Users\\duncan.runnacles\\Documents\\Programming\\Python\\LogIT\\Regression_Test_Data\\Run_Summary\\test_noresults.tlf', 'No results tlf_path fail')
